...
function main() {
    ...
    ansible-playbook -i inventory remove_ansible.yml -K -e hosts_group=$hosts_group
...
function printUsage() {
    ...
    echo -e "Ensures that Ansible is not installed on the supplied hosts_group. If not supplied "
